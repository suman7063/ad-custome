...
const CustomeDropdown = ({
  ...
  return (
    <div
      className="w-full relative cursor-pointer rounded bg-white"
      ref={dropdownRef}
    >
      <div
        className="h-[40px] border rounded border-gray-500 flex px-2 items-center justify-between w-full text-sm text-black"
